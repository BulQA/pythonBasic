...
# )
#
# n_sound = int(input('Сколько песен выбрать? '))
#
# total_time = 0
#
# for top in range(1, n_sound + 1):
#     name, duration = random.choice(violator_songs)
#     print(f'Название {i}-й песни: {name}')
#     total_time += duration
#
...
#
#
# team_3 = ['Погиб' if team_1[i] + team_2[i] > 100 else 'Выжил' for i in range(10)]
#
